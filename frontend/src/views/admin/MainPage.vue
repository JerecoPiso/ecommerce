<template>
            ...
            <div class="row">
                <AdminCards name="Total Products" :total="totalProducts" class-name="fa-brands fa-product-hunt" bgc="bg-green"></AdminCards>
                <AdminCards name="Total Orders" :total="parseInt(1236)" class-name="fa-solid fa-bag-shopping" bgc="bg-blue"></AdminCards>
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4">
                    <div class="top-selling-products">
                        ...
                        <TopSelling v-for="p in popularProducts" :key="p.id" :pname="p.product_name" :img-src="'/images/'+p.img_name" :sold="p.sold"></TopSelling>
