<template>
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div>
                    ...
                    <button type="button" class="minus" @click="MinusQty">-</button><input type="number" v-model="quantity"  class="qty"><button type="button" @click="AddQty" class="plus">+</button>
        ...
        <div class="user-feedback">
            ...
            <div class="comment-box">
                ...
                <p class="comment">“Thank you Apple and techworld. Good quality and bought it at a discounted price. Had a delay with the delivery but understandable bc high volume of orders. Thank you.” <br> <span>2022-08-27 23:27</span> </p>
            </div>
        </div>
        <div class="user-feedback">
            <div >
        ...
        AddToCart(){
            ...
            if(this.quantity == 0){
               ...
               // var pid = 0;
                ...
                //     pid = this.$cookies.get('cart').length
